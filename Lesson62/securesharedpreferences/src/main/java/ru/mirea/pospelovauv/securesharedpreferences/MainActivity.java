package ru.mirea.pospelovauv.securesharedpreferences;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            // Получаем имя поэта
            String actorName = secureSharedPreferences.getString("secure", "Анна Асти");
            ...
            editor.putString("secure", "Анна Асти");
            editor.putString("annaasti", "annaasti");
            editor.apply();

            // Получаем имя файла изображения из SharedPreferences
            String photoName = secureSharedPreferences.getString("annaasti", "annaasti");
